...
const foodSound = new Audio('js/music/food.mp3');
const gameOversound = new Audio('js/music/gameover.mp3')
const moveSound = new Audio("js/music/move.mp3")
const musicSound = new Audio('js/music/music.mp3')
let speed = 5;
let lastPaintTime = 0;
let snakeArr = [
    {
